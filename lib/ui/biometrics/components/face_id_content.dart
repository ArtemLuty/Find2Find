...
class FaceIdContent extends StatelessWidget {
  FaceIdContent({Key? key}) : super(key: key);
    ...
    return GetBuilder<BiometricsController>(
      builder: (_) => AnimatedSwitcher(
          child: biometricsController.isEnabled
              ? buildBiometricsEnabled(isFingerprint: false)
              : buildContent(),
        ...
        Expanded(
          child: Column(
            children: [
              ...
              Text(
                "Enable Face ID for an even smoother sign in experience next time.",
